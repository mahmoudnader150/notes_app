                    ...
                    children: [
                      ...
                      defaultButton(function: ()async{
                        if(formKey.currentState!.validate()) {
                          NoteCubit.get(context).updateNote(noteNameController.text, noteContentController.text,NoteCubit.get(context).cubitColor,note.id);                          // Note note = Note(name:noteNameController.text,content: noteContentController.text );
                          // print(note);
